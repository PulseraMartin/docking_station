...
CC2650SensorTag.prototype.readEDA = function(callback) {
  // OJO deberian ser MPU9250_UUID, MPU9250_DATA_UUID ----- o sea EDA_UUID, EDA_PERIDO_UUID
...
CC2650SensorTag.prototype.convertPpgData = function(data, callback) {
  ...
  aux_1 = data.readUInt8(2);
  aux_2 = data.readUInt8(1);
  aux_3 = data.readUInt8(0);
  //a1[0] = a1[0]+(aux<<16);
  a1[0] = aux_1 + (aux_2<<8) + (aux_3<<16);
  aux_1 = data.readUInt8(5);
  aux_2 = data.readUInt8(4);
  aux_3 = data.readUInt8(3);
  //a1[0] = a1[0]+(aux<<16);
  a2[0] = aux_1 + (aux_2<<8) + (aux_3<<16);
...
CC2650SensorTag.prototype.enableMax3010 = function(callback) {
  ...
  this.writeUInt8Characteristic(MAX3010_UUID, MAX3010_CONFIG_UUID, 0x03, callback);
};
...
CC2650SensorTag.prototype.readMAX3010 = function(callback) {
  ...
  // TODO: revisar
  this.readDataCharacteristic(MAX3010_UUID, MAX3010_DATA_UUID, function(error, data) {
    if (error) {
      return callback(error);
    }
