...
CC2650SensorTag.prototype.convertEDAData = function(data, callback) {
  ...
  a3=  data.readUInt8(6)<<16;
  Rs=a1+a2+a3;
  var a4 = 0;
  callback(V0, Vb, Rs, a4);
};
...
CC2650SensorTag.prototype.convertPpgData = function(data, callback) {
  // LA IDEA ES TOMA DATA Y HACER LAS OPERACIONES BINARIAS PARA OBTENER LAS INFO
  ...
  //
  // var a1 = data.readInt16LE(0);
  // var a2 = data.readInt16LE(1);
  // var a3 = data.readInt16LE(2);
  // var a4 = data.readInt16LE(3);
  callback(a1, a2, a3, a4);
};

CC2650SensorTag.prototype.setMax3010Period = function(period, callback) {
  console.log("PERIODO MAX301: " + period);
...
CC2650SensorTag.prototype.setMPU9250PeriodNew = function(period, callback) {
  console.log("Seteando temp period: " + period);
  console.log("A");
  var characteristic = this._characteristics[MPU9250_UUID][MPU9250_PERIOD_UUID];
  characteristic.write( new Buffer([0x14]), true, function(error) {
