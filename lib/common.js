...
SensorTagCommon.prototype.setDeviceID = function(callback) {
  ...
  // var period_hex = '0x0303'.toString(16).toUpperCase();
...
///// enablePPGColour
SensorTagCommon.prototype.enablePPGConfigCharacteristic = function(serviceUuid, characteristicUuid, callback) {
  this.writeUInt8Characteristic(serviceUuid, characteristicUuid, 0x07, callback);
};
///////
